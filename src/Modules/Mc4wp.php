...
final class Mc4wp extends AbstractModule
{
    ...
    public function features(): array
    {
        return [
            ...
            'premium-ads' => [
                'label' => __('Remove Premium ads from its screens', 'wppack-tidy-admin'),
                // MC4WP_Admin_Ads outputs nothing but Premium pitches (it is not
                // even registered when Premium is active)
                'noticeDenyByHook' => [
                    'mc4wp_admin_sidebar' => [
            ...
            'breadcrumb' => [
                'label' => __('Hide the "You are here" breadcrumb', 'wppack-tidy-admin'),
                'adminCss' => <<<'CSS'
