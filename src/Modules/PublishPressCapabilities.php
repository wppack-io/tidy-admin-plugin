    ...
    public function features(): array
    {
        return [
            ...
            'panel-placement' => [
                ...
                'adminCss' => <<<'CSS'
                body[class*="page_pp-capabilities"] #tidy-admin-meta-region { position: absolute; top: 0; left: 20px; right: 0; z-index: 100; }
                body[class*="page_pp-capabilities"] #tidy-admin-meta-region #screen-meta { box-shadow: 0 8px 16px rgba(0, 0, 0, 0.15); }
                CSS,
            ],
        ];
    }
